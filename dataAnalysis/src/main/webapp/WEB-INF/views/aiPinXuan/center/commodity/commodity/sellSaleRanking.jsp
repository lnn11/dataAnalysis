...
<body>
<div>
	<div id="p" class="easyui-panel" title="销售额商品排名" style="width:100%;padding:20px;" data-options="cls:'theme-panel-blue'">
		<div style="height: 50px; width:1100px; font-size: 16px; margin-top: 20px">
			<div style="height: 50px; float: left;">
				统计方式：<input type="radio" id="sellsales">按销量
					  <input type="radio" id="sellsale" checked="checked">按销售额
				<span style="margin-left: 60px;">排名：前</span>
				<input type="text" id="salesNum" value="10" style="width: 60px;height: 20px;border: 1px solid gray;"/><span>名</span>
			</div>
			<div style="height: 50px; float: right;">
				...
				<a onclick="tong_sellSaleRanking()" class="easyui-linkbutton" style="background-color: #e2e2e2">统计</a>
			</div>
		</div>
		<div>
			商品分类：
		...
		<div style="margin-top: 20px;">
			<table id="sellSaleRankingTable" hidden="true" border="1" cellpadding="0" cellspacing="0" width="1100px" height="150px"></table>
		</div>
		<div align="center" id="x1" style="margin-top: 5px">
			...
			共<span id="countPages"></span>页
		</div>
		<div id="barSellRaking2" style="width: 1200px;height: 500px;margin-left: 10px;margin-top: 10px; border: 1px;"></div>
	</div>
</div>
	<script type="text/javascript" src="js/aiPinXuan/center/commodity/commodity/sellSaleRanking.js"></script>
</body>
</html>